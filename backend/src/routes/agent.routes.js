...
router.post("/complaints/:id/approve-resolution", authenticate, authorize("MUNICIPAL_AGENT"), (req, res) => agentController.approveResolution(req, res));
router.post("/complaints/:id/reject-resolution", authenticate, authorize("MUNICIPAL_AGENT"), (req, res) => agentController.rejectResolution(req, res));
