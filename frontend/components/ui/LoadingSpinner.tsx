  ...
  const spinner = (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="relative">
        {/* Background circle */}
        <div
          className={`${sizes[size]} border-4 border-primary/20 rounded-full`}
        />

        {/* Animated spinner */}
        <div
          className={`absolute inset-0 ${sizes[size]} border-4 border-primary border-t-transparent rounded-full animate-spin`}
        >
          {/* Gradient effect */}
