        ...
        <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-xl border border-slate-200 z-50 animate-in slide-in-from-top-2 duration-200 max-h-96 overflow-y-auto">
          ...
          <div className="divide-y divide-slate-100">
            {todayNotifs.length > 0 && (
              <div>
                <h4 className="px-4 py-2 text-xs font-semibold text-slate-500 uppercase tracking-wider">Today</h4>
            ...
            {earlierNotifs.length > 0 && (
              <div>
                <h4 className="px-4 py-2 text-xs font-semibold text-slate-500 uppercase tracking-wider">Earlier</h4>
