...
import { getReturnUrl, clearReturnUrl } from '@/lib/auth-utils';
...
function LoginForm() {
  ...
  const { login, isLoading, error, user, hydrated, clearError } =
    useAuthStore();
  ...
  useEffect(() => {
    ...
    if (user) {
      // First check for sessionStorage returnUrl (saved before redirect)
      ...
      // Fallback to URL redirect parameter
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8 animate-fadeIn">
            ...
            <p className="text-slate-600">{mt('login.subtitle')}</p>
            <div className="mt-3">
              <Link
                href="/transparency"
