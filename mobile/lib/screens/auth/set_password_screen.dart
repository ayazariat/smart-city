    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Mot de passe défini avec succès!')),
        );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Créez un mot de passe sécurisé pour ${widget.email}',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isLoading
                      ...
                      : const Text('Définir le mot de passe', style: TextStyle(fontSize: 16)),
                ),
              ),
            ],
          ),
