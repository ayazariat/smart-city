...
# Geographic proximity is strict: > 150m apart → geo=0.0 (not a duplicate)
# Same location + similar text → passes threshold
# When coordinates are missing, geo fallback = 0.5 (same municipality)
DUPLICATE_WEIGHTS = {
    "textSimilarity": 0.50,
