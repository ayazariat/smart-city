...
- [ ] 2.1 Make user table fully responsive
- [ ] 2.2 Ensure all user details appear on all screen sizes (mobile-first approach)
- [ ] 2.3 Add responsive cards for mobile view instead of table
...
- [ ] 5.1 Add authentication (login/register) screens
- [ ] 5.2 Add complaint submission functionality
- [ ] 5.3 Add complaint listing/history
- [ ] 5.4 Add profile management
- [ ] 5.5 Implement API client with proper token handling
- [ ] 5.6 Match web colors (Civic Green theme)
